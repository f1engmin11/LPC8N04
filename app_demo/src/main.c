...
static void Init(void)
{
	...
	while( SysTick_Config(1 * 1000 * SYSTICK_INTERVAL) )
	{
		;
	}
	...
	Chip_TIMER_PrescaleSet(LPC_TIMER16_0, 1000);// PR  PC==PR --> TC++
	Chip_TIMER_SetMatch(LPC_TIMER16_0, 0, CT16B_INTERVAL);// MR(x)  TC==MR(X) --> INT
