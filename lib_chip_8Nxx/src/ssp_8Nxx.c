...
static CLOCK_PERIPHERAL_T Chip_SSP_GetClockIndex(LPC_SSP_T *pSSP)
{
...
static SYSCON_PERIPHERAL_RESET_T Chip_SSP_GetResetIndex(LPC_SSP_T *pSSP)
{
...
uint32_t Chip_SSP_GetBitRate(LPC_SSP_T *pSSP)
{
